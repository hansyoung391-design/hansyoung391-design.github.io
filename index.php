    ...
    <div class="card">
        ...
        <section class="intro">
            <div class="content">
                ...
                <h2 class="fade-top-3">Hanis</h2>
                <h2 class="fade-top-3">&</h2>
                <h2 class="fade-top-3">Tawfik</h2>
                <p class="date fade-top-4">
                    <span>Sabtu</span>
                    <span>|</span>
                    <span>27 Disember 2025</span>
                </p>
            </div>
        </section>
        ...
        <section class="info">
            ...
            <div class="event-info reveal fade-bottom">
                <div class="one">
                    ...
                    <p>kami</p>
                    <div class="parent">
                        <p>Zainab Binti Omar (Ibu)</p>
                        <p>(Balu Allahyarham Mohd Haron Bin Zamzam)
                        <p>&</p>
                        <p>Mohd Tarmizi Bin Mohd Haron</p>
                    </div>
                    <p>Menjemput</p>
                    <p>Dato' | Datin | Tuan | Puan | Encik | Cik</p>
                    <p>seisi keluarga hadir ke</p>
                    <p>majlis perkahwinan puteri /adik kami</p>
                </div>
                <div class="two">
                    <p>Hanis Syazani Binti Mohd Haron</p>
                    <p>&</p>
                    <p>Mohd Tawfik Bin Mohd Khalid</p>
                </div>
                <div class="three">
                    <p class="title">Tempat</p>
                    <p>Dewan Semai Bakti Felda Semenchu</p>
                    <p>Felda Semenchu</p>
                    <p>81900 Kota Tinggi,Johor</p>
                </div>
                <div class="four">
                    <p class="title">Tarikh</p>
                    <p>Sabtu, 27 Disember 2025</p>
                    <p>Bersamaan 26 Jamadil Akhir 1447H</p>
                </div>
                <div class="five">
    ...
    <div id="calendar-menu" class="toggle-menu">
        <div class="calendar">
            ...
            <p>
                <span>27 Disember 2025</span>
                <span>|</span>
                <span>26 Jamadil Akhir 1447H</span>
            </p>
            <div class="button">
            ...
            <div class="content">
                ...
                <div class="person">
                    <div class="first-section">
                        ...
                        <div class="name">
                            <span>Mizie</span>
                            <span>Abang Pengantin</span>
                        </div>
                    </div>
                    <div class="second-section">
                        <button onclick="makePhoneCall('+60177414936')"><i class='bx bx-phone'></i></button>
                        <button onclick="openWhatsApp('+60177414936')"><i class='bx bxl-whatsapp'></i></button>
                    </div>
                </div>
                <div class="person">
                    <div class="first-section">
                    ...
                    <div class="second-section">
                        <button onclick="makePhoneCall('+60137899419')"><i class='bx bx-phone'></i></button>
                        <button onclick="openWhatsApp('+60137899419')"><i class='bx bxl-whatsapp'></i></button>
                    </div>
                </div>
            </div>
        </div>
